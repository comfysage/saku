...
#![deny(missing_docs)]
#![doc(html_root_url = "https://docs.rs/saku_logger/0.1.0")]
...
//! ## Changes
//!
//! changes from [pretty_env_logger](https://docs.rs/pretty_env_logger/0.5.0/pretty_env_logger/):
...
pub fn try_init_custom_env(environment_variable_name: &str) -> Result<(), log::SetLoggerError> {
    ...
    let env = ::std::env::var(environment_variable_name).unwrap_or("info".to_string());
...
fn colored_level<'a>(style: &'a mut Style, level: Level) -> StyledValue<'a, &'static str> {
    match level {
        ...
        Level::Debug => style.set_color(Color::Ansi256(15)).value("DEBUG"),
